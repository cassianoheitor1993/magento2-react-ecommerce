...
class Config
{
    private const XML_PATH_ENABLED = 'petshop_blog/ai/enabled';
    private const XML_PATH_API_KEY = 'petshop_blog/ai/api_key';
    private const XML_PATH_MODEL = 'petshop_blog/ai/model';
    private const XML_PATH_BASE_URL = 'petshop_blog/ai/base_url';
