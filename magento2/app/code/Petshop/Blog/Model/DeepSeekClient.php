...
class DeepSeekClient
{
    ...
    public function generatePostWithContext(
        ...
        return [
            ...
            'author' => $this->normalizeText($decoded['author'] ?? 'Petshop AI Editor'),
            'is_published' => 1
        ];
    }
    ...
    ): array
    {
        ...
        $this->logger->info('Petshop Blog AI request payload', [
            'operation' => $operation,
        ...
        $this->logger->info('Petshop Blog AI response payload', [
            'operation' => $operation,
            'status' => $status,
