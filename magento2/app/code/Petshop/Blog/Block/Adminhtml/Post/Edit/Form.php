<?php
namespace Petshop\Blog\Block\Adminhtml\Post\Edit;

use Magento\Backend\Block\Widget\Form\Generic;
use Magento\Cms\Model\Wysiwyg\Config as WysiwygConfig;
use Magento\Framework\Data\FormFactory;
use Magento\Framework\Registry;
use Petshop\Blog\Model\Config as BlogConfig;
...
class Form extends Generic
{
    ...
    {
        $post = $this->_coreRegistry->registry('petshop_blog_post');
    ...
    private function renderAiFieldActions(string $field): string
    {
        ...
        return sprintf(
            '<button type="button" class="action-secondary petshop-ai-field-action" data-field="%1$s" title="%2$s">✨</button><span id="petshop-ai-badge-%1$s" class="petshop-ai-badge is-hidden">%3$s</span>',
            $field,
