...
namespace Petshop\Homepage\Model\Service;

use Petshop\Blog\Model\DeepSeekClient;
use Petshop\Homepage\Model\Service\StoreContextProvider;
...
class WidgetAiGenerationService
{
    ...
    private function getSystemPrompt(string $widgetType): string
    {
        ...
        return sprintf(
            'You are a senior ecommerce content strategist for a pet supplies online store called Petshop. '
...
Return only JSON.',
    ...
    private function fallbackCta(string $context): array
    {
        ...
        return [
            'content' => [
                ...
                'body' => 'Join thousands of happy pet parents who trust Petshop for quality nutrition, toys, and wellness products.',
    ...
    {
        return [
            'headline' => 'Join the Petshop Pack',
