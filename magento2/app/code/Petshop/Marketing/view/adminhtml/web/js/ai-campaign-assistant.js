define([
    ...
    return function init(config, element) {
        ...
        const $status = $('#petshop-ai-campaign-status');
        const $results = $('#petshop-ai-campaign-results');
        const $button = $('#petshop-ai-load-suggestions');
        ...
        const renderSuggestions = function (suggestions, responseMeta) {
            ...
            suggestions.forEach(function (item, index) {
                ...
                const $card = $('<div/>', { class: 'petshop-ai-campaign-card' });
                $('<div/>', { class: 'petshop-ai-campaign-card-title', text: title }).appendTo($card);
                ...
                if (reason) {
                    $('<div/>', { class: 'petshop-ai-campaign-card-reason', text: reason }).appendTo($card);
                }
