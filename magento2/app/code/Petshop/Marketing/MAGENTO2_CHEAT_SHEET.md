# Magento 2 Cheat Sheet + Petshop Marketing Module Starter
...
Example: `Petshop_Blog`

Path:

- `magento2/app/code/Petshop/Blog`
...
```bash
cd /home/cmedeiros/Documents/Cassiano-Portfolio/PHP-Projects/magento2_ecomm
./magento.sh module:enable Petshop_Blog
./magento.sh setup:upgrade
./magento.sh cache:flush
```
...
## 6) Petshop Marketing Module (Complete Starter Blueprint)
...
- `magento2/app/code/Petshop/Marketing`
...
└── view/adminhtml/
    ├── layout/
    │   ├── petshop_marketing_campaign_index.xml
    │   └── petshop_marketing_campaign_edit.xml
    ├── ui_component/
    │   ├── petshop_marketing_campaign_listing.xml
    │   └── petshop_marketing_campaign_form.xml
    └── templates/
...
```json
{
  "name": "petshop/module-marketing",
  "description": "Petshop Marketing Campaigns",
...
<schema xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <table name="petshop_marketing_campaign" resource="default" engine="innodb" comment="Petshop Marketing Campaign">
        ...
        <index referenceId="PETSHOP_MARKETING_CAMPAIGN_STATUS" indexType="btree">
            <column name="status"/>
        </index>
    </table>

    <table name="petshop_marketing_campaign_job" resource="default" engine="innodb" comment="Petshop Marketing Campaign Job">
        ...
        <constraint xsi:type="foreign" referenceId="PETSHOP_MARKETING_JOB_CAMPAIGN_ID"
                    table="petshop_marketing_campaign_job" column="campaign_id"
                    referenceTable="petshop_marketing_campaign" referenceColumn="campaign_id"
                    onDelete="CASCADE"/>

        <constraint xsi:type="unique" referenceId="PETSHOP_MARKETING_JOB_CAMPAIGN_EMAIL_UNQ">
            <column name="campaign_id"/>
            <column name="recipient_email"/>
        </constraint>

        <index referenceId="PETSHOP_MARKETING_JOB_STATUS" indexType="btree">
            <column name="status"/>
        </index>
    </table>
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <router id="admin">
        <route id="petshop_marketing" frontName="petshop_marketing">
            <module name="Petshop_Marketing" before="Magento_Backend"/>
        </route>
    </router>
</config>
```
...
<acl xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <resources>
        <resource id="Magento_Backend::admin">
            <resource id="Petshop_Marketing::marketing" title="Petshop Marketing" sortOrder="10">
                <resource id="Petshop_Marketing::campaigns" title="Campaigns" sortOrder="10"/>
            </resource>
        </resource>
    </resources>
</acl>
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <menu>
        <add id="Petshop_Marketing::marketing"
             title="Petshop Marketing"
             module="Petshop_Marketing"
             sortOrder="90"
             resource="Petshop_Marketing::marketing"/>

        <add id="Petshop_Marketing::campaigns"
             title="Email Campaigns"
             module="Petshop_Marketing"
             sortOrder="10"
             parent="Petshop_Marketing::marketing"
             action="petshop_marketing/campaign/index"
             resource="Petshop_Marketing::campaigns"/>
    </menu>
</config>
```
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <topic name="petshop.marketing.campaign.send" request="string"/>
</config>
```
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <exchange name="magento" type="topic" connection="amqp">
        <binding id="petshopMarketingSendBinding"
                 topic="petshop.marketing.campaign.send"
                 destinationType="queue"
                 destination="petshop.marketing.campaign.send"/>
    </exchange>
</config>
```
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <publisher topic="petshop.marketing.campaign.send">
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <consumer name="petshop.marketing.campaign.send"
              queue="petshop.marketing.campaign.send"
              connection="amqp"
              handler="Petshop\Marketing\Model\Queue\Consumer\CampaignSendConsumer::process"/>
</config>
```
...
```php
<?php
namespace Petshop\Marketing\Model\ResourceModel\Campaign;
...
class Collection extends AbstractCollection
{
    protected function _construct()
    {
        $this->_init(\Petshop\Marketing\Model\Campaign::class, \Petshop\Marketing\Model\ResourceModel\Campaign::class);
    }
}
```
...
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <preference for="Petshop\Marketing\Api\CampaignRepositoryInterface"
                type="Petshop\Marketing\Model\CampaignRepository"/>
</config>
```
...
```bash
cd /home/cmedeiros/Documents/Cassiano-Portfolio/PHP-Projects/magento2_ecomm
./magento.sh module:enable Petshop_Marketing
./magento.sh setup:upgrade
./magento.sh cache:flush
```
...
```bash
./magento.sh queue:consumers:start petshop.marketing.campaign.send
```
