...
namespace Petshop\Marketing\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'petshop_marketing/campaign/edit';
    private const URL_PATH_ENQUEUE = 'petshop_marketing/campaign/enqueue';
    private const URL_PATH_PAUSE = 'petshop_marketing/campaign/pause';
    private const URL_PATH_RESUME = 'petshop_marketing/campaign/resume';
    private const URL_PATH_CANCEL = 'petshop_marketing/campaign/cancel';
