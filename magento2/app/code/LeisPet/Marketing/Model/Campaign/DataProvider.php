...
namespace LeisPet\Marketing\Model\Campaign;

use LeisPet\Marketing\Model\ResourceModel\Campaign\CollectionFactory;
...
class DataProvider extends AbstractDataProvider
{
    ...
    public function getData(): array
    {
        ...
        $data = $this->dataPersistor->get('leispet_marketing_campaign');
        if (!empty($data)) {
