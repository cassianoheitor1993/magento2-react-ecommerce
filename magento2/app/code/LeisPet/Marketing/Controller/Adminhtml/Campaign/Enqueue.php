...
class Enqueue extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Campaign enqueued successfully.'));
            ...
            $this->messageManager->addErrorMessage(__('Failed to enqueue campaign: %1', $e->getMessage()));
            return $this->resultRedirectFactory->create()->setPath('*/*/edit', ['campaign_id' => $campaignId]);
        }
    }
}