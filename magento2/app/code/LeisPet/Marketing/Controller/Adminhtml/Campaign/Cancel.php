        ...
        try {
            ...
            if ($isAjax) {
                return $result->setData([
                    'success' => true,
                    'message' => __('Campaign cancelled successfully')
                ]);
            }

            $this->messageManager->addSuccessMessage(__('Campaign cancelled successfully.'));
            ...
            $this->messageManager->addErrorMessage(__('Failed to cancel campaign: %1', $e->getMessage()));
            return $this->resultRedirectFactory->create()->setPath('*/*/edit', ['campaign_id' => $campaignId]);
        }
    }
}