...
namespace LeisPet\Homepage\Ui\Component\Listing\Column;
...
{
    private const URL_PATH_EDIT = 'leispet_homepage/widget/edit';
    private const URL_PATH_DELETE = 'leispet_homepage/widget/delete';
    private const URL_PATH_SORT = 'leispet_homepage/widget/sort';
