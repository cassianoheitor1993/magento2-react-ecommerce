define([
    ...
    var FORM_NS = 'leispet_homepage_widget_form.leispet_homepage_widget_form';
    ...
    return function (config, element) {
        ...
        var $button = $('#leispet-widget-ai-generate');
        var $status = $('#leispet-widget-ai-status');
        var $editorContainer = $('#leispet-widget-edit-config-editor');
        ...
        $button.on('click', function () {
            var widgetType = getWidgetTypeValue();
            var context = $('#leispet-widget-ai-context').val();
